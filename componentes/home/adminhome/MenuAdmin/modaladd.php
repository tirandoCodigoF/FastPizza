      ...
      <div class="modal-body">
        ...
        <form action="POST" class="formulario_registro1" id="form" >
         <div class="form-group">
          ...
          <button type="submit" class="btn btn-danger"  data-dismiss="modal" >Cerrar</button>
          -->
         <input type="submit" class="btn btn-success" id="upusuarios1" value="Guardar">  
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" id="elimina" class="btn btn-primary" data-dismiss="modal">Aceptar</button>
